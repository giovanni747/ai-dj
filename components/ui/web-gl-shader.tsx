  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Shift beams up by subtracting from p.y (since p.y is positive upwards)
        // p.y - 0.9 means the center line is at p.y = 0.9
        float yOffset = -0.9;
    ...
    const initScene = () => {
      ...
      // Set clear color to transparent so we can overlay if needed, or keep black if it's a background
    ...
    // Use ResizeObserver for element resize instead of window resize
