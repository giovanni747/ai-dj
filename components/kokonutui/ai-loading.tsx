...
const TASK_SEQUENCES = [
    {
        status: "Crate digging",
        lines: [
            "Warming up the decks...",
            "Scanning your favorite artists...",
            "Tuning energy and vibe...",
            "Sampling intros and hooks...",
            "Locking in the groove...",
        ],
    },
    {
        status: "Mixing the set",
        lines: [
            "Beatmatching transitions...",
            "Balancing energy and valence...",
            "Crossfading genres you love...",
            "Weaving in similar artists...",
            "Dropping a surprise track...",
            "Checking danceability...",
            "Dialing in tempo and mood...",
            "Leveling the master bus...",
        ],
    },
    {
        status: "Sound check",
        lines: [
            "Testing flow from open to peak...",
            "Avoiding disliked genres...",
            "Highlighting vocal moments...",
            "Sequencing choruses and drops...",
        ...
        <div className="flex items-center justify-center min-h-full w-full">
            <div className="space-y-4 w-auto">
                ...
                <div className="relative">
                    ...
                    {/* Removed scroll indicator overlay */}
                </div>
            </div>
        </div>
    );
